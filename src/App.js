            ...
            <div className="lg:col-span-3 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                <h1 className="text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight text-balance">
                  Hi, I'm <span className="text-[#C5EBC3]">Xing Ying</span>
                </h1>
            ...
            <FadeIn delay={100}>
              <div className="flex flex-col gap-5">
                <p className="text-lg text-[#a8a29e] leading-relaxed">
                  ...
                  excited when technology solves real problems and creates
                  impact.
                </p>

                <p className="text-lg text-[#a8a29e] leading-relaxed">
                  Right now, I'm working on projects that sit between
                  engineering and product, where I get to think about users,
                  constraints and trade-offs. I believe great products come from
                  balancing what's technically possible with what users truly
                  need.
                </p>
              </div>
            </FadeIn>
